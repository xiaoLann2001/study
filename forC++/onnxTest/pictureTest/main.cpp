...
int main()
{
	...
	for (int i = 0; i <= n; i++)
	{
		...
		string imgpath_src = "/home/book/Pictures/" + s;
		string imgpath_dst = "/home/book/Pictures/result" + s;
		cout << imgpath_src << endl;

		Mat srcimg = imread(imgpath_src);
		yolo_model.detect(srcimg);
		imwrite(imgpath_dst, srcimg);
		cout << imgpath_dst << endl;
